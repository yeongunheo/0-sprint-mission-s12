...
public class BasicNotificationService implements NotificationService {
    ...
    public void createAll(Set<UUID> receiverIds, String title, String content,
        ...
        List<NotificationDto> notificationDtos = notificationRepository.saveAll(notifications).stream()
                .map(notificationMapper::toDto)
                .toList();
        ...
        // 이벤트 발행
        eventPublisher.publishEvent(new MultipleNotificationCreatedEvent(notificationDtos));
    }
} 
